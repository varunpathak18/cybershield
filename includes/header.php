...
<nav class="navbar">
  ...
  <div class="nav-right">
    ...
    <a href="<?= APP_URL ?>/ai-agent-security.php" class="nav-link <?= $currentPage==='ai-agent-security'?'active':'' ?>" style="<?= $currentPage==='ai-agent-security'?'':'color:var(--cyan)' ?>">🤖 AI Agents</a>
